...
> = {
  SUPER_ADMIN: {
    label: "Super Admin",
    description:
      "Highest level access. Can manage platform settings, billing, and all system resources.",
    color: "text-purple-700 dark:text-purple-300",
  },
  PLATFORM_ADMIN: {
    label: "Platform Admin",
    description:
      "High-level administrative access. Can manage users, monitor platform activity, and configure system modules.",
    color: "text-blue-700 dark:text-blue-300",
  },
  SUPPORT_STAFF: {
    label: "Support Staff",
    description:
      "Operational access. Can view data, manage grievances, and assist users without administrative privileges.",
    color: "text-emerald-700 dark:text-emerald-300",
  },
  BILLING_MANAGER: {
    label: "Billing Manager",
    description:
      "Access restricted to financial operations, subscriptions, and usage reports.",
...
export default function PermissionsOverview() {
  ...
  const [activeTab, setActiveTab] = useState<string>("PLATFORM_ADMIN");
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          {Object.entries(ROLE_META).map(([role, meta]) => (
            <TabsContent key={role} value={role}>
              {role === "SUPER_ADMIN" && (
                <div className="mb-4 p-4 bg-purple-50 border border-purple-200 rounded-lg text-purple-800 text-sm flex items-start gap-3">
                  <Info className="h-5 w-5 shrink-0 mt-0.5" />
                  <p>
                    <strong>Note:</strong> Super Admins have full access to all
                    platform capabilities, including multi-tenant management and
                    billing.
                  </p>
                </div>
              )}
              ...
              {role === "PLATFORM_ADMIN" && (
                <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg text-blue-800 text-sm flex items-start gap-3">
                  <Info className="h-5 w-5 shrink-0 mt-0.5" />
                  <p>
                    <strong>Note:</strong> Platform Admins manage the day-to-day
                    operations and configurations for the entire platform.
                  </p>
                </div>
              )}
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Use this matrix to define the baseline access for Platform
                Admins, Support Staff, and Billing Managers. Super Admins
                maintain top-level governance.
              </p>
            </div>
          </div>
        </Card>
