...
export interface User {
  ...
  name: string;
  email: string;
  role: "SUPER_ADMIN" | "PLATFORM_ADMIN" | "SUPPORT_STAFF" | "BILLING_MANAGER";
  ...
  forcePasswordChange?: boolean; // Keep for safety if backend implements it
}
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const loadPermissions = useCallback(async () => {
    try {
      ...
      // Platform might not have permissions route yet, just log and continue
      console.warn("Failed to load permissions (endpoint may not exist):", error);
      setState((prev) => ({
        ...prev,
        permissions: [],
        permissionsByModule: {},
