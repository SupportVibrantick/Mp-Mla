...
router.use("/appointments", requireModule("meeting", "appointments", "dashboard"), appointmentRoutes);
...
router.use("/documents", requireModule("dashboard"), documentRoutes);
router.use("/correspondence", requireModule("dashboard"), correspondenceRoutes);
