...
import constituencyRoutes from "./constituency/index.js";
...
import janataDarbarRoutes from "./janataDarbar/index.js";
import schemeRoutes from "./schemes/index.js";
...
router.use("/tasks", requireModule("tasks"), taskRoutes);
...
router.use("/appointments", requireModule("appointments"), appointmentRoutes);
router.use("/janata-darbar", requireModule("janata_darbar"), janataDarbarRoutes);
router.use("/schemes", requireModule("schemes"), schemeRoutes);
router.use("/crm", requireModule("crm"), crmRoutes);
router.use("/documents", requireModule("documents"), documentRoutes);
router.use("/correspondence", requireModule("correspondence"), correspondenceRoutes);
