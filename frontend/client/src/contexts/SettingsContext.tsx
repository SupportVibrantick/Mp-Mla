...
export function SettingsProvider({ children }: { children: React.ReactNode }) {
    ...
    const applyBranding = (data: Record<string, string>) => {
        ...
        if (data.brand_primary_color) {
            ...
            root.style.setProperty("--sidebar-primary", hexToHsl(data.brand_primary_color));
        }
    ...
    return (
        <SettingsContext.Provider value={{ settings, isLoading, refreshSettings: fetchBranding }}>
            {children}
